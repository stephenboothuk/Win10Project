...
/****** Object:  View [dbo].[hardware_readiness_B]    Script Date: 02/07/2019 17:44:47 ******/
DROP VIEW [dbo].[hardware_readiness_B]
GO
...
create view [dbo].[hardware_readiness_B] 
as
...
, dbo.IsItOK4(hw.Model, hw.[Free_Disk_Space_(GB)], hw.[RAM_(MB)], hw.[CPU_speed_(MHz)], 100, 3000, 2000)  as IsItOK
